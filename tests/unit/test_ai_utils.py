...
from src.services.ai_utils import AIPrompts, AIService, PromptTemplate, get_ai_service
...
class TestPromptTemplate:
    ...
    def test_format_with_optional_variables(self):
        ...
        result = template.format(
            name="John", department="Engineering", greeting="Welcome!"
        )
    ...
    def test_format_extra_variables(self):
        ...
        template = PromptTemplate(template="Hello {name}", required_variables=["name"])
