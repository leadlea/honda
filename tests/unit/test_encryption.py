...
class TestEncryptionService:
    ...
    @patch.dict(os.environ, {'KMS_KEY_ID': 'test-key-id', 'ENCRYPTION_PASSWORD': 'test-pass', 'ENCRYPTION_SALT': 'test-salt'})
    ...
    @patch.dict(os.environ, {'KMS_KEY_ID': 'test-key-id', 'ENCRYPTION_PASSWORD': 'test-password', 'ENCRYPTION_SALT': 'test-salt'})
