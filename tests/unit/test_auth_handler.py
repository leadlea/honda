...
class TestAuthHandler:
    ...
    def test_register_user_success(self):
        ...
        # Setup mocks
        with patch("src.handlers.auth_handler.cognito_client") as mock_cognito, patch(
            "src.handlers.auth_handler.users_table"
        ) as mock_table:
    ...
    def test_login_user_success(self):
        ...
        with patch("src.handlers.auth_handler.cognito_client") as mock_cognito, patch(
            ...
            "src.handlers.auth_handler.get_user_id_from_token"
        ) as mock_get_user_id:
    ...
    def test_logout_user_success(self):
        ...
        with patch("src.handlers.auth_handler.cognito_client") as mock_cognito, patch(
            "src.handlers.auth_handler.extract_token_from_header"
        ) as mock_extract:
            mock_extract.return_value = "access-token"
            mock_cognito.global_sign_out.return_value = {}

            event = {"headers": {"Authorization": "Bearer access-token"}}
    ...
    def test_refresh_token_success(self):
        ...
        with patch("src.handlers.auth_handler.cognito_client") as mock_cognito:
            ...
            event = {"body": json.dumps({"refresh_token": "refresh-token"})}
    ...
    def test_get_user_profile_success(self):
        ...
        with patch(
            "src.handlers.auth_handler.get_user_id_from_event"
