...
class TestSecurityAuditor:
    ...
    def test_log_logout(self, mock_logger):
        ...
        self.auditor.log_logout(user_id="user123", source_ip="192.168.1.1")
    ...
    def test_send_to_cloudwatch_success(self, mock_cloudwatch):
        ...
        mock_cloudwatch.create_log_group.side_effect = (
            mock_cloudwatch.exceptions.ResourceAlreadyExistsException()
        )
        mock_cloudwatch.create_log_stream.side_effect = (
            mock_cloudwatch.exceptions.ResourceAlreadyExistsException()
        )
...
class TestSecurityAuditUtilities:
    ...
    def test_extract_request_info_with_headers(self):
        ...
        assert (
            request_info["source_ip"] == "203.0.113.1"
    ...
    def test_extract_request_info_fallback_ip(self):
        ...
        assert (
            request_info["source_ip"] == "192.168.1.1"
        )  # Fallback to identity.sourceIp
