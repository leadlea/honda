...
class TestQuestionnaireHandler:
    ...
    @pytest.mark.asyncio
    async def test_generate_questionnaire_success(self, mock_get_ai_service, mock_get_user):
        ...
        mock_ai_service.generate_questionnaire = AsyncMock(return_value=questionnaire_data)
        ...
        self.handler.questionnaire_repo.get_user_questionnaires = AsyncMock(return_value=[])
        ...
        self.handler.questionnaire_repo.create_questionnaire = AsyncMock(return_value=mock_questionnaire)
    ...
    async def test_submit_questionnaire_success(self, mock_get_user):
        ...
        self.handler.questionnaire_repo.get_by_id = AsyncMock(return_value=mock_questionnaire)
    ...
    async def test_get_questionnaire_history_success(self, mock_get_user):
        ...
        self.handler.questionnaire_repo.get_user_questionnaires = AsyncMock(return_value=mock_questionnaires)
    ...
    @patch('src.handlers.questionnaire_handler.get_ai_service')
    @pytest.mark.asyncio
    async def test_regenerate_questionnaire_success(self, mock_get_ai_service, mock_get_user):
        ...
        # Mock AI service
        mock_ai_service = Mock()
        mock_ai_service.generate_questionnaire = AsyncMock(return_value=new_questionnaire_data)
        mock_get_ai_service.return_value = mock_ai_service
        ...
        # Mock repositories
        self.handler.questionnaire_repo.get_by_id = AsyncMock(return_value=mock_original)
        self.handler.user_repo.get_by_id = AsyncMock(return_value=mock_user)
        self.handler.profile_repo.get_by_user_id = AsyncMock(return_value=mock_profile)
        self.handler.questionnaire_repo.create_questionnaire = AsyncMock(return_value=mock_new_questionnaire)
    ...
    async def test_update_profile_from_responses(self):
        ...
        assert 'Developer' in update_data['preferences']['preferred_roles']  # Existing preserved
