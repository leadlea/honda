...
from src.handlers.matching_handler import (
    ...
    handle_batch_generate_recommendations,
    handle_generate_recommendations,
    handle_get_match_analysis,
...
class TestMatchingHandler:
    ...
    def test_lambda_handler_routing_get_recommendations(
        self, mock_event_base, mock_context
    ):
        """Test Lambda handler routing to get recommendations."""
        with patch(
            "src.handlers.matching_handler.handle_get_recommendations"
        ) as mock_handler:
    ...
    def test_lambda_handler_routing_generate_recommendations(self, mock_context):
        ...
        with patch(
            "src.handlers.matching_handler.handle_generate_recommendations"
        ) as mock_handler:
    ...
    def test_lambda_handler_routing_match_analysis(self, mock_context):
        ...
        with patch(
            "src.handlers.matching_handler.handle_get_match_analysis"
        ) as mock_handler:
            mock_handler.return_value = {"statusCode": 200, "body": "{}"}
    ...
    def test_lambda_handler_unknown_endpoint(self, mock_context):
        ...
        event = {"httpMethod": "GET", "path": "/unknown/endpoint", "headers": {}}
    ...
    def test_lambda_handler_exception_handling(self, mock_context):
        ...
        event = {"httpMethod": "GET", "path": "/recommendations/veteran123"}
...
class TestGetRecommendations:
    ...
    def test_get_recommendations_success(
        ...
        mock_engine = Mock()
        mock_engine.recommendation_repo.get_user_recommendations.return_value = (
            mock_recommendations
        )
    ...
    def test_get_recommendations_no_token(self, mock_verify_token):
        ...
        event = {"headers": {}, "pathParameters": {"user_id": "veteran123"}}
    ...
    @patch("src.handlers.matching_handler.verify_jwt_token")
    @patch("src.handlers.matching_handler.require_permission")
    def test_get_recommendations_insufficient_permissions(
        self, mock_require_permission, mock_verify_token
    ):
    ...
    @patch("src.handlers.matching_handler.verify_jwt_token")
    @patch("src.handlers.matching_handler.require_permission")
    def test_get_recommendations_missing_user_id(
        self, mock_require_permission, mock_verify_token
    ):
...
class TestGenerateRecommendations:
    ...
    def test_generate_recommendations_success(
        self, mock_asyncio, mock_get_engine, mock_require_permission, mock_verify_token
    ):
        ...
        event = {
            "headers": {"Authorization": "Bearer valid_token"},
            "pathParameters": {"user_id": "veteran123"},
            "body": json.dumps({"min_score_threshold": 0.5, "max_recommendations": 5}),
        }
    ...
    @patch("src.handlers.matching_handler.get_matching_engine")
    @patch("src.handlers.matching_handler.asyncio")
    def test_generate_recommendations_with_criteria(
        self, mock_asyncio, mock_get_engine, mock_require_permission, mock_verify_token
    ):
...
class TestMatchAnalysis:
    ...
    @patch("src.handlers.matching_handler.get_matching_engine")
    @patch("src.handlers.matching_handler.asyncio")
    def test_get_match_analysis_success(
        self, mock_asyncio, mock_get_engine, mock_require_permission, mock_verify_token
    ):
    ...
    def test_analyze_match_success(
        ...
        mock_engine.opportunity_repo.get_opportunity.return_value = (
            Mock()
        )  # Mock opportunity
        ...
        event = {
            "headers": {"Authorization": "Bearer valid_token"},
            "body": json.dumps({"user_id": "veteran123", "opportunity_id": "opp123"}),
        }
    ...
    @patch("src.handlers.matching_handler.require_permission")
    @patch("src.handlers.matching_handler.get_matching_engine")
    def test_analyze_match_profile_not_found(
        self, mock_get_engine, mock_require_permission, mock_verify_token
    ):
...
class TestBatchRecommendations:
    ...
    @patch("src.handlers.matching_handler.get_matching_engine")
    @patch("src.handlers.matching_handler.asyncio")
    def test_batch_generate_recommendations_success(
        self, mock_asyncio, mock_get_engine, mock_require_permission, mock_verify_token
    ):
        ...
        mock_engine = Mock()
        mock_engine.batch_generate_recommendations = AsyncMock(
            ...
            "body": json.dumps(
                {
                    ...
                    "criteria": {"min_score_threshold": 0.5, "max_recommendations": 5},
                }
            ),
        }
    ...
    @patch("src.handlers.matching_handler.verify_jwt_token")
    @patch("src.handlers.matching_handler.require_permission")
    def test_batch_generate_recommendations_non_admin(
        self, mock_require_permission, mock_verify_token
    ):
