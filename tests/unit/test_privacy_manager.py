...
class TestPrivacyManager:
    ...
    def test_update_privacy_settings_success(self):
        ...
        result = self.privacy_manager.update_privacy_settings('test-user-123', privacy_settings)
    ...
    def test_update_privacy_settings_profile_not_found(self):
        ...
        result = self.privacy_manager.update_privacy_settings('nonexistent-user', privacy_settings)
    ...
    def test_sync_external_visibility_make_public(self):
        ...
        profile.privacy_settings = {'is_publicly_visible': True, 'external_contact': True}
        
        result = self.privacy_manager._sync_external_visibility(profile, was_public=False)
    ...
    def test_sync_external_visibility_make_private(self):
        ...
        profile = self.mock_profile
        profile.privacy_settings = {'is_publicly_visible': False, 'external_contact': False}
        
        result = self.privacy_manager._sync_external_visibility(profile, was_public=True)
    ...
    def test_validate_privacy_settings_warnings(self):
        ...
        assert 'external_contact is enabled but profile is not publicly visible' in result['warnings'][0]
