...
from src.utils.performance import (
    ConnectionPool, DynamoDBOptimizer, performance_timer, performance_monitor
)
...
class BaseRepository:
    ...
    def get_item(self, key: Dict[str, Any], unprotect_pii: bool = True) -> Optional[Dict[str, Any]]:
    ...
    def query(self, key_condition_expression: str, 
        ...
        try:
            ...
            performance_monitor.record_metric(
                f'dynamodb_query_items_returned_{self.table_name}',
                len(items),
                'count'
            )
