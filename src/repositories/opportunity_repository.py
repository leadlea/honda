...
class OpportunityRepository(BaseRepository):
    ...
    def get_opportunities_by_type(
        self, opportunity_type: str, limit: Optional[int] = None
    ) -> List[Opportunity]:
    ...
    def get_opportunities_by_company(
        ...
        try:
            items = self.scan(
                ...
                expression_attribute_values={":company": company, ":active": True},
                limit=limit,
            )
            return [Opportunity.from_dynamodb_item(item) for item in items]
        except Exception as e:
    ...
    def search_opportunities_by_skills(
        ...
        try:
            ...
            for item in items:
                ...
                required_skills_lower = [
                    skill.lower() for skill in opportunity.required_skills
                ]
    ...
    def get_recent_opportunities(
        ...
        try:
            ...
            items = self.scan(
                ...
                expression_attribute_values={":cutoff": cutoff_iso, ":active": True},
                limit=limit,
            )
