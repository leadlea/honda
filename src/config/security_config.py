...
class DataClassification:
    ...
    PII_FIELDS = {
        ...
        'full_name', 'birth_date', 'personal_phone', 'home_address',
        'emergency_contact', 'medical_info'
    }
    
    # Sensitive business fields
    SENSITIVE_FIELDS = {
        'salary', 'performance_rating', 'compensation', 'review_notes',
        'disciplinary_actions', 'internal_notes', 'manager_feedback'
    }
    
    # Fields that can be shown publicly (with anonymization)
    PUBLIC_SAFE_FIELDS = {
        'skills', 'experience', 'certifications', 'business_title',
        'department', 'years_of_service', 'specializations', 'interests'
    }
    
    # Fields that require audit logging
    AUDIT_REQUIRED_FIELDS = {
        'role', 'permissions', 'access_level', 'privacy_settings',
        'profile_visibility', 'contact_preferences'
    }
...
class AuditConfig:
    ...
    AUDIT_EVENTS = {
        ...
        'profile_update', 'privacy_change', 'role_change',
        'data_access', 'data_export', 'admin_action',
        'security_violation', 'rate_limit_exceeded'
    }
    
    # High-risk events that require immediate alerting
    HIGH_RISK_EVENTS = {
        'multiple_failed_logins', 'privilege_escalation',
...
def get_security_config() -> Dict[str, Any]:
    ...
    return {
        ...
        'cors': {
            'allowed_origins': SecurityHeaders.ALLOWED_ORIGINS
        },
        'rate_limiting': {
