...
class CommunicationMessage:
    ...
    recipient_id: str
    message: str
    message_type: str = "general"  # 'general', 'status_update', 'interview_request', 'feedback'
    timestamp: str = field(default_factory=lambda: datetime.utcnow().isoformat())
    is_read: bool = False
...
class ApplicationStatusService:
    ...
    def update_status_with_workflow(self, application_id: str, new_status: str, 
        ...
        try:
            ...
            # Send notifications
            self._notify_status_change(application, old_status, new_status, updated_by, notes)
    ...
    def send_communication_message(self, application_id: str, sender_id: str, 
        ...
        try:
            ...
            self._notify_new_message(application, sender_id, recipient_id, message, message_type)
    ...
    def get_application_communications(self, application_id: str, user_id: str) -> Dict[str, Any]:
        """
    ...
    def _notify_status_change(self, application: Application, old_status: str, 
                            new_status: str, updated_by: str, notes: str) -> None:
        """
        ...
        try:
            ...
            notification_data = {
                ...
                'opportunity': {
                    ...
                    'company': opportunity.company if opportunity else 'Unknown Company'
                },
                'status_change': {
                    'old_status': old_status,
                    'new_status': new_status,
    ...
    def _notify_new_message(self, application: Application, sender_id: str, 
                          recipient_id: str, message: str, message_type: str) -> None:
        """
