...
class PublicProfile:
    ...
    work_style: str = ""
    contact_preferences: Dict = field(default_factory=dict)  # {"allow_contact": bool, "preferred_method": str}
    is_active: bool = True
    ...
    def sync_from_veteran_profile(self, veteran_profile) -> None:
        ...
        # Copy experiences
        self.experiences = veteran_profile.experiences.copy() if veteran_profile.experiences else []
        ...
        if hasattr(veteran_profile, 'preferences') and veteran_profile.preferences:
            self.preferred_roles = veteran_profile.preferences.get('preferred_roles', [])
