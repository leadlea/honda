...
class Application:
    ...
    def validate(self) -> List[str]:
        ...
        valid_statuses = ['submitted', 'under_review', 'interview_scheduled', 'accepted', 'rejected', 'withdrawn']
    ...
    def update_status(self, new_status: str, reviewer_id: Optional[str] = None, notes: str = "") -> None:
