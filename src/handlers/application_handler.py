...
class ApplicationHandler:
    ...
    def submit_application(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            application_type = body.get(
                "application_type", "interest"
            )  # 'interest' or 'formal_application'
            ...
            existing_application = self.application_repo.check_existing_application(
    ...
    def get_user_applications(
        ...
        try:
            ...
            # Get applications
            if status_filter:
                applications = self.application_repo.get_user_applications_by_status(
                    user_id, status_filter, limit
                )
            else:
                applications = self.application_repo.get_user_applications(
                    user_id, limit
                )
    ...
    def get_application_details(
        ...
        try:
            ...
            if application.user_id != user_id and not rbac_manager.has_permission(
                user_info["role"], Permission.MANAGE_APPLICATIONS
            ):
                return {
                    "statusCode": 403,
            ...
            return {"statusCode": 200, "body": json.dumps(app_data)}
    ...
    def withdraw_application(
        ...
        try:
            ...
            success = self.application_repo.withdraw_application(
    ...
    def update_application_status(
        ...
        try:
            ...
            success = self.application_repo.update_application_status(
                application_id, new_status, user_info["user_id"], reviewer_notes
            )
    ...
    def get_applications_for_opportunity(
        ...
        try:
            ...
            applications = self.application_repo.get_applications_for_opportunity(
    ...
    def _notify_stakeholders(
        ...
        try:
            ...
            if not applicant:
                logger.warning(
                    f"Could not find applicant {application.user_id} for notification"
                )
                return
    ...
    def get_application_communications(
        ...
        try:
            ...
            result = status_service.get_application_communications(
                application_id, user_id
            )
    ...
    def update_application_status_with_workflow(
        self, event: Dict[str, Any], context: Any
    ) -> Dict[str, Any]:
        """
