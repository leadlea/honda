...
from src.utils.rbac import rbac_manager, validate_role, get_available_roles
from src.utils.security_audit import security_auditor, extract_request_info, SecurityEventType, RiskLevel
from src.utils.security_headers import security_middleware, create_secure_response, create_error_response
...
def register_user(event: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if not validate_role(role):
            ...
            return create_response(400, {'error': f'Invalid role. Must be one of: {available_roles}'})
    ...
    try:
        ...
        return create_response(200, {
            ...
            'user': {
                ...
                'permissions': [perm.value for perm in rbac_manager.get_user_permissions(user_data.get('role', ''))]
            }
        })
