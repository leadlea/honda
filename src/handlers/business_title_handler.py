...
class BusinessTitleHandler:
    ...
    async def generate_business_titles(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if not profile:
                return {
                    'statusCode': 404,
                    'body': json.dumps({'error': 'Profile not found. Please complete your profile first.'})
                }
    ...
    async def select_business_title(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.info(f"Updated business title for user {user_id} to: {selected_title}")
    ...
    async def regenerate_business_titles(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            await self._store_title_generation_history(user_id, titles_data, regenerated=True)
    ...
    async def get_title_history(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
        """
    ...
    async def _store_title_generation_history(self, user_id: str, titles_data: Dict[str, Any], 
        ...
        try:
            ...
            # Update profile
            await self.profile_repo.update_profile(user_id, {
...
async def generate_business_titles(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
...
async def regenerate_business_titles(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
